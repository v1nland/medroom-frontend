export function formatCompetencias(data) {
    var table_data = {
        labels: [],
        datasets: [],
    };
    ...
    for (i = 0; i < data["valores"]["ANAM"].length; i++) {
        table_data["datasets"][0]["data"].push(data["valores"]["ANAM"][i]["promedio_grupo"]);
    ...
    for (i = 0; i < data["valores"]["EXFI"].length; i++) {
        table_data["datasets"][1]["data"].push(data["valores"]["EXFI"][i]["promedio_grupo"]);
    ...
    for (i = 0; i < data["valores"]["HACO"].length; i++) {
        table_data["datasets"][2]["data"].push(data["valores"]["HACO"][i]["promedio_grupo"]);
    ...
    for (i = 0; i < data["valores"]["JUCL"].length; i++) {
        table_data["datasets"][3]["data"].push(data["valores"]["JUCL"][i]["promedio_grupo"]);
    ...
    for (i = 0; i < data["valores"]["OREF"].length; i++) {
        table_data["datasets"][4]["data"].push(data["valores"]["OREF"][i]["promedio_grupo"]);
    ...
    for (i = 0; i < data["valores"]["PROF"].length; i++) {
        table_data["datasets"][5]["data"].push(data["valores"]["PROF"][i]["promedio_grupo"]);
    ...
    //     table_data["datasets"][6]["data"].push(data["valores"]["VAGL"][i]["promedio_grupo"]);
